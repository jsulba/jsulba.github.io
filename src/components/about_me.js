      ...
      <div>
        ...
        <div id="footer" className={classes.footer}>
          <ButtonGroup className={classes.footerButtonGroup} variant="text">
              <a className={classes.link} href="https://github.com/jsulba" target="_blank"><Button theme={theme}><GitHubIcon className={classes.footerButton}/></Button>Github</a>
              <a className={classes.link} href="https://www.linkedin.com/in/jose-ale-fernandez/" target="_blank"><Button theme={theme}><LinkedInIcon className={classes.footerButton} /></Button>LinkedIn</a>
              <a className={classes.link} href="https://scsconcordia.com/" target="_blank"><Button ><OpenInNewIcon className={classes.footerButton} /></Button>SCS Website</a>
          </ButtonGroup>
        </div>
      </div>
    );
